...
useEffect(() => {
  ...
  return (
    <>
            <div className='w-1/2 p-10 font-Montserrat text-my-primary border rounded-md shadow-sm bg-white mx-auto md:translate-x-20 lg:translate-x-20 xl:translate-x-10 -translate-y-80'>
